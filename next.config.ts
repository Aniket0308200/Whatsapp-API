...
const nextConfig: NextConfig = {
  // Keep native Node modules out of webpack bundling
  ...
  async headers() {
    ...
    return [
      // Only apply the immutable Cache-Control for /_next/static in production.
      // In development, Next.js (Turbopack) manages these headers itself; overriding
      // them breaks HMR chunk revalidation and causes the "module factory not available"
      // stale-cache error in the browser.
      ...(isProd
        ? [
            {
